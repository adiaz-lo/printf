...
//	long		lnum;
	...
	str = "Hola, me llamo Halfons";
	strn = "Hola, esto es una prueba de printf";
	decimal = 42;
	//fnum = 42.24;
	inum = -42;
	unum = 21;
...
//	printf ("%x",&p);
	...
	//printf("printf %%i Multiple test: %i %s %p %u\n", zero, strn, &str, unum);
	//ft_printf("ft_printf %%i Multiple test: %i %s %p %u\n", zero, strn, &str, unum);
	//printf("printf %%i Multiple test: %i %i %s %s %p %p %u %u of different conversions\n", zero, zero, strn, strn, &str, &str, unum, unum);
	//ft_printf("ft_printf %%i Multiple test: %i %i %s %s %p %p %u %u of different conversions\n", zero, zero, strn, strn, &str, &str, unum, unum);
	printf("Test pointer: %p\n", &str);
	printf("Test pointer: %p\n", str);
	ft_printf("ft_printf Test pointer: %p\n", &str);
